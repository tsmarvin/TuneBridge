...
The custom lexicon is defined in `wwwroot/.well-known/atproto-lexicon/media.tunebridge.dev.lookup.result` and served at `https://<your-domain>/.well-known/atproto-lexicon/media.tunebridge.dev.lookup.result`:
