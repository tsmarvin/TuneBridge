...
public class ApiKeyProvider(
    ...
    private class ApiKey(
        ...
        public IReadOnlyCollection<System.Security.Claims.Claim> Claims { get; } = roles.Select( role => new System.Security.Claims.Claim( System.Security.Claims.ClaimTypes.Role, role ) ).ToList( );
    }
}
