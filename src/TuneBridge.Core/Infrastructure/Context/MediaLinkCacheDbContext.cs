...
using TuneBridge.Core.Infrastructure.Entity;

namespace TuneBridge.Core.Infrastructure.Context {
    ...
    public class MediaLinkCacheDbContext(
        DbContextOptions<MediaLinkCacheDbContext> options
    ) : DbContext( options ) {
