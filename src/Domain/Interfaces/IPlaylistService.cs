...
namespace BridgeBeats.Domain.Interfaces {
    ...
    public interface IPlaylistService {
        ...
        /// <returns>The playlist entry, or null if not found or expired.</returns>
        Task<PlaylistEntry?> GetPlaylistAsync( string playlistId );
        ...
        Task<List<PlaylistEntry>> GetUserPlaylistsAsync( string userId );
        ...
        Task<List<PlaylistEntry>> ExportUserDataAsync( string userId );
    }
}
