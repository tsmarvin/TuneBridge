...
- **Required environment variables**: Validated in `containers/entrypoint.sh` for Docker
...
- Configuration loaded from `appsettings.json` (or generated by `containers/entrypoint.sh` in Docker)
- Settings model: `BridgeBeats.Web.Configuration.AppSettings`
