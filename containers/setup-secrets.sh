...
create_secret_file "$SECRETS_DIR/redis_password.txt" \
    "Redis password (random string for authentication)" \
    "$(openssl rand -base64 32 2>/dev/null || echo 'REPLACE_WITH_RANDOM_PASSWORD_DO_NOT_USE_THIS_DEFAULT')"
