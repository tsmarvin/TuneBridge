...
public class HomeControllerTests {
    ...
    public async Task Privacy_ReturnsSuccessStatusCode( ) {
        // Act
        HttpResponseMessage response = await _client!.GetAsync("/Home/Privacy");
    ...
    public async Task Error_ReturnsSuccessStatusCode( ) {
        // Act
        HttpResponseMessage response = await _client!.GetAsync("/Home/Error");
    ...
    public async Task NonExistentRoute_ReturnsNotFound( ) {
        // Act
        HttpResponseMessage response = await _client!.GetAsync("/NonExistent/Route");
